                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row mb-2">
                                                            <div class="col text-start">
                                                                <label for="message-text" class="col-label">Email:</label>
                                                                <p>{{ $user->email }}</p>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-2 text-start">
                                                            <div class="col-4">
                                                                <label for="message-text" class="col-label">Username:</label>
                                                                <p>{{ $user->username }}</p>
                                                            </div>
                                                            <div class="col-4">
                                                                <label for="message-text" class="col-label">Role:</label>
                                                                <p>{{ $user->role->name }}</p>
                                                            </div>
                                                            <div class="col-4">
                                                                <label for="message-text" class="col-label">Phone:</label>
                                                                <p>{{ $user->phone }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
