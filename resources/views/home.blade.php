  ...
  <div class="container">
    <div class="row justify-content-between">
      ...
      <div class="col-lg-5 ps-lg-5">
        ...
        <p class="fs-6">
          Kami menyediakan layanan perbaikan untuk berbagai jenis alat elektronik. Dengan tim teknisi yang berpengalaman dan terlatih, kami memastikan setiap perbaikan dilakukan dengan teliti dan profesional, menggunakan suku cadang berkualitas tinggi untuk menjamin performa optimal. Berikut daftar contoh jasa perbaikan yang kami tawarkan:
        </p>
  ...
  <div class="container">
    <div class="row justify-content-between">
      <div class="col-lg-6">
        ...
        <p>Kami menyediakan layanan perbaikan untuk berbagai jenis alat elektronik, selain itu kami juga menawarkan pelayanan yang terbaik serta harga yang terjangkau.</p>

        <div class="row my-5">
          <div class="col-6 col-md-6 mb-4">
            <div class="feature mb-2">
              <h3><i class="bi bi-geo-alt icon-service"></i> Onsite Repair</h3>
              <p>Kami akan datang ke tempat anda dan memperbaiki di tempat. Sehingga anda dapat mengontroll dan melihatnya secara langsung proses dari perbaikanya.</p>
            </div>
          </div>
          ...
          <div class="col-6 col-md-6 mb-4">
            <div class="feature mb-2">
              ...
              <p>Kami menjamin setiap perbaikan dilakukan dengan teliti dan profesional. sehingga kualitas dari perbaikan yang dilakukan terjamin dan terjaga.</p>
            </div>
          </div>
          ...
          <div class="col-6 col-md-6">
            <div class="feature mb-2">
              ...
              <p>Harga dari biaya perbaikan yang fleksibel, tergantung dari kerusakan dari barang yang diperbaiki.</p>
            </div>
          </div>
