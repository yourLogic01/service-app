    ...
    <div class="container relative">
        <div class="row g-4 mb-3">
            <div class="col-lg-10">
                ...
                <p>Anda dapat memesan jasa kami melewati tab order diatas tanpa datang ke tempat kami atau
                    dapat juga datang ke tempat kami, atau hubungi kami jika ada yang ditanyakan. Pesan kapanpun dan
                    dimanapun!</p>

                <ul class="list-unstyled custom-social">
                    <li>
                        <a href="{{ $data->facebook_url }}" target="_blank"><span
                                class="fa fa-brands fa-facebook-f"></span></a>
                    </li>
                    <li>
                        <a href="{{ $data->instagram_url }}" target="_blank"><span
                    ...
                    <li>
                        <a href="{{ $data->whatsapp_url }}" target="_blank"><span
                ...
                <div class="row links-wrap">
                    <div class="col-6 col-sm-6 col-md-3">
                        <ul class="list-unstyled">
                            <li class="mb-5"><a href="#">About us</a></li>
