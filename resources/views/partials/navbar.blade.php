<nav id="navbarExample" class="custom-navbar navbar navbar-expand-md navbar-dark bg-dark sticky-top"
    ...
    <div class="container">
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="/"><img src="{{ asset('images/logo.png') }}" alt="samid service"
                style="width: 2.4rem;"> {{ config('app.name') }}<span>.</span></a>
                ...
                @if (Auth::check())
                    ...
                    <li class="nav-item dropdown text-decoration-none">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <span class="me-2 d-lg-inline text-gray-600">{{ Auth::user()->username }}</span>
                        </a>
