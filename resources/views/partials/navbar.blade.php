...
<nav id="navbarExample" class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark sticky-top" arial-label="Furni navigation bar">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarsService">
        <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
          ...
          <li class="nav-item {{ request()->routeIs('post') ? 'active' : '' }} || {{ request()->routeIs('post.show') ? 'active' : '' }}"><a class="nav-link " href="{{ route('post') }}">Blog</a></li>
          <li class="nav-item {{ request()->routeIs('order') ? 'active' : '' }}"><a class="nav-link " href="{{ route('order') }}">Order</a></li>
          @if (Auth::check())
        ...
        <ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
          <li class="nav-item">
            <a href="{{ route('login') }}" class="btn btn-secondary me-2 nav-link px-4 "><i class="bi bi-person"></i> Login</a>
          </li>
        </ul>
        @endif
