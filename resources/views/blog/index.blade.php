        ...
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                <div style="height: 250px; overflow:hidden;">
                    <img src="{{ asset('storage/' . $posts[0]->thumbnail) }}" alt="{{ $posts[0]->title }}"
                        class="img-fluid">
                </div>
                <h3 class="card-title"><a class="text-decoration-none text-dark"
                        href="/post/detail/{{ $posts[0]->slug }}">{{ $posts[0]->title }}</a></h3>
                <p>
                ...
                <a class="text-decoration-none btn btn-primary" href="/post/detail/{{ $posts[0]->slug }}">Baca lebih
                    lanjut</a>
            </div>
        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="card-title"><a class="text-decoration-none text-dark"
                                        href="/post/detail/{{ $post->slug }}">{{ $post->title }}</a></h5>
                                <p>
                                    <small class="text-body-secondary">
                                ...
                                <a href="/post/detail/{{ $post->slug }}" class="btn btn-primary">Baca lebih lanjut</a>
                            </div>
                        </div>
                    </div>
                @endforeach
